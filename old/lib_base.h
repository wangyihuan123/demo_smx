...
#  include "mstp_lib_bitmap.h"
//#  include "mstp_icc.h"
#  include   "iccQLib.h"
#  include   "mstp_com_lib.h"
#  include   "mstp_com_defs.h"
#  include   "mstp_com_util.h"
#  define Print printf
#else
#  include <psos.h>
#  include "comdef.h"
...
#include "mstp_lib_bpdu.h"
#include "mstp_lib_vector.h"
#include "mstp_lib_times.h"
...
extern char* stp_sprint_time_stamp (void);

#ifdef __LINUX__
extern char* sprint_time_stump (void);
#ifdef SLR_STP_CODE
#define stp_trace(F, B...) MSTP_TRC(MSTP, MINOR + (FMASK & F_STP_LIB_ALL), \
						"%s:" F "\n", stp_sprint_time_stamp(), ##B)
#else
